	...
	<div class="sup-content employee-top">
		<div class="row">
			...
			<div class="control-group pull-left ml10">
				<div class="control-container pull-left box-w160">
					<div class="input-box">
						<input class="control-text input-full" type="text" id="staffName" name="" value="" placeholder="员工名称">
					</div>
				</div>
			</div>
...
<script>
var orgId = $('#selectOrgHotelId').val();
var nodeType = 1;
BUI.use(['bui/grid', 'bui/data', 'bui/overlay', 'bui/tree', 'bui/extensions/treepicker',], function(Grid, Data, Overlay, Tree, TreePicker) {
	...
	var Grid = Grid,
        Store = Data.Store,
        columnsLeft = [
			{ title: '帐号',dataIndex: 'account', elCls: 'text-left', width: 70, showTip: true },
			{ title: '姓名',dataIndex: 'name', elCls: 'text-left', width: 70, showTip: true },
			{ title: '组织',dataIndex: 'orgInfo', elCls: 'text-left', width: 150, showTip: true }
		];
    var storeLeft = new Store({
    	url : '<c:url value="/workflowapprover/listforaddper"/>',
    	params : {
    		'orgId':orgId,
    		'nodeType':nodeType
   		}, 
